...
- (id)initWithCommandDescription:(NSScriptCommandDescription *)commandDesc {
	...
	NSLog(@"initWithCommandDescription called");
	
	[[NSNotificationCenter defaultCenter] 
		postNotificationName:@"MOOReloadCurrentLocation" 
					  object: nil];
...
- (id)performDefaultImplementation {
	NSLog(@"performDefaultImplementation called");
}
*/
@end
